...
public class TabelData extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (selectedRow == -1) {
            ...
            try {
                String query = "UPDATE tbhandphone SET merk = ?, processor = ?, ram = ?, memori_internal = ?, tahun_rilis = ? WHERE id = ?";
    ...
    private void txtcariKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtcariKeyTyped
        ...
        try{
            String query = "Select * from tbhandphone where merk like '%" + txtcari.getText() + "%'";
